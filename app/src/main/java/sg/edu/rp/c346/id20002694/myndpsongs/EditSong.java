...
public class EditSong extends AppCompatActivity {
    ...
    sg.edu.rp.c346.id20002694.myndpsongs.Song data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        data = (sg.edu.rp.c346.id20002694.myndpsongs.Song) i.getSerializableExtra("data");
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sg.edu.rp.c346.id20002694.myndpsongs.DBHelper dbh = new sg.edu.rp.c346.id20002694.myndpsongs.DBHelper(sg.edu.rp.c346.id20002694.myndpsongs.EditSong.this);
